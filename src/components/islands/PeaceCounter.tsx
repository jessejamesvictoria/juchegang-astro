  ...
  return (
    <section className="border-b-2 border-[var(--ink)]" aria-label="Peace dialogue counter">
      ...
      <div className="container-app">
        <div className="grid md:grid-cols-12 border-x-2 border-[var(--ink)] blueprint-canvas relative">
          <span className="crosshair-mark tl" aria-hidden="true">+</span>
          <span className="crosshair-mark br" aria-hidden="true">+</span>

          <div className="md:col-span-4 cell border-b-2 md:border-b-0 md:border-r-2 border-[var(--ink)] reveal">
            ...
            <dl className="mt-8 space-y-3">
              <div className="flex justify-between gap-4 border-t border-[var(--ink)] pt-2">
